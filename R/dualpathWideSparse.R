...
dualpathWideSparse <- function(y, D, x=NULL, approx=FALSE, maxsteps=2000,
  ...
  # Define beta and u, with proper names
  ...
  dualpathObjs = list(dualpathType="wide_sparse",r=r, B=B, I=I, Q1=NA, approx=approx,
                               Q2=NA, k=k, df=df, D1=D1, D2=D2, Ds=Ds, ihit=ihit,
                               m=m, n=n, q=q, h=h, R=NA, q0=NA, tol=tol, s=s, y=y,
                               D=D, u=u, X=NA)
